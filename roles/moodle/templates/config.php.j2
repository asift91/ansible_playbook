...
$CFG->dbhost    = {{ dbhost | quote }};  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = {{ dbname | quote }};     // database name, eg moodle
$CFG->dbuser    = {{ dbuser | quote }};   // your database username
$CFG->dbpass    = {{ dbpass | quote }};   // your database password
